    ...
    <SidebarProvider defaultOpen={true}>
      <div className="flex min-h-screen bg-gray-50 w-full">
        <Sidebar>
          <SidebarHeader>
            <div className="p-2">
              <h2 className="text-lg font-bold">Pricing Platform</h2>
              <p className="text-xs text-sidebar-foreground/70">Manage your pricing strategy</p>
            </div>
          </SidebarHeader>
          <SidebarContent>
            <SidebarGroup>
          ...
          <SidebarFooter>
            <div className="p-4">
              <div className="text-xs text-sidebar-foreground/70 mb-2">Logged in as</div>
              <div className="font-medium text-sm truncate">{userData.email}</div>
            </div>
          </SidebarFooter>
        </Sidebar>
